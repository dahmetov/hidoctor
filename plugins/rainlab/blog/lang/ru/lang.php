...
return [
    ...
    'hours' => [
        'plugin'      => [
            'name'        => 'Режим работы',
            'description' => 'Отражает режим работы на Вашем сайте',
        ],
        'common'      => [
            ...
            'hours_special'       => 'Специальный режим работы',
            'hours_special_label' => 'специальный режим работы',
        ],
        'hours'       => [
            'from' => 'С',
            'to'   => 'По',
        ...
        'date'        => [
            ...
            'yearly_comment' => 'Это правило повторяется каждый год в одно и то же время',
        ],
        'exceptions'  => [
            'hours_comment' => 'Оставить пустым, если местоположение закрыто в это время',
        ],
        'permissions' => [
            'manage' => 'Возможность управлять режимом работы',
        ],
        'weekdays'    => [
            'Воскресенье',
            'Понедельник',
        ...
        'titles'      => [
            'locations' => [
                'reorder' => 'Сортировать местоположения',
            ],
        ],
        'components'  => [
            'opening_hours' => [
                'name'        => 'Режим Работы',
                'description' => 'Отображает режим работы',
                'slug'        => [
                    'title'       => 'Идентификатор местоположения',
                    'description' => 'Получить определенное местоположение по идентификатору',
                ],
            ],
        ],
    ],
    'post' => [
        ...
        'price_name' => 'Наименование',
        'price_value' => 'Стоимость',
        'add_price' => 'Добавить стоимость услуг',
    ],
    'categories' => [
